...
static const unsigned short dc_kbd_keycode[NR_SCANCODES] = {
	...
	KEY_CUSTOM_COSMO_DPAD_LEFT,KEY_CUSTOM_COSMO_DPAD_RIGHT,KEY_CUSTOM_COSMO_DPAD_UP,KEY_CUSTOM_COSMO_DPAD_DOWN,KEY_CUSTOM_COSMO_DPAD_CENTER,STM32_WAKE_MTK
};
