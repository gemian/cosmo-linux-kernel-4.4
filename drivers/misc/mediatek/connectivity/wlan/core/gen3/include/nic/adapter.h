...
/* CMD_PS_PROFILE_T         ePowerSaveMode; */
	CMD_PS_PROFILE_T arPowerSaveMode[MAX_BSS_INDEX + 1];
	UINT_32 u4PowerSaveFlag[MAX_BSS_INDEX + 1];
...
typedef struct {
	...
	UINT_32 u4FwOwnVersionExtend; /*support version extended*/
