...
//㊣赤那?sensor米?????1∟℅¯?㏒那?℅∩足?㏒oinit preview capture video hvideo svideo
typedef enum{
	IMGSENSOR_MODE_INIT,
...
//extern bool hi556_read_eeprom( kal_uint16 addr, BYTE* data, kal_uint32 size);

#endif 

/*
PREVIEW:??芍?車?binning mode㏒? 2⊿???a那?Binning average?1那?Binning sum㏒?AVERAGE
那1車?GP﹞?那?㏒? shutter米㊣?～豕?谷豕??o車㏒?????豕?谷迆D∫㏒?
Static  DPC ON
slim video   2?車?米?120fps～谷?㏒
get sensor id and Open()  has more code need to reused. need to modify the two place
20150513 米迆辰?∩?o?豕?PDAF2?那y
