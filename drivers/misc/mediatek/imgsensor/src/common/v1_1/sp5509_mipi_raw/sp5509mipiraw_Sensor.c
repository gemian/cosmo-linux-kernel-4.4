...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = SP5509_SENSOR_ID,		//Sensor ID Value: 0x30C8//record sensor id defined in Kd_imgsensor.h
  ...
  .custom5 = {
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_Gb,//SENSOR_OUTPUT_FORMAT_RAW_Gr,//sensor output first pixel color
...
UINT32 sp5509_MIPI_RAW_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
