...
*******************************************************************************/
#ifdef STK_TUNE0
    #define STK_MAX_MIN_DIFF	140 //200
    #define STK_LT_N_CT	115//40 100
    #define STK_HT_N_CT	130//60 150
...
#else
    obj->ps_high_thd_boot = obj->ps_stat_data[1] + STK_H_HT; //obj->stk_ht_n_ct;
    obj->ps_low_thd_boot = obj->ps_stat_data[1] + STK_H_LT; //obj->stk_lt_n_ct;
    atomic_set(&obj->ps_high_thd_val, obj->ps_high_thd_boot);
    atomic_set(&obj->ps_low_thd_val, obj->ps_low_thd_boot);
#endif
